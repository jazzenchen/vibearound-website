---
title: Local-first Agent Architecture
description: The technical model behind VibeAround's local-first AI coding agent workspace, API Bridge, remote entry points, and session coordination.
---
