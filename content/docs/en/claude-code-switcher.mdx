...
1. Create one provider profile in [Provider Profiles & API Bridge](/docs/provider-profiles).
...
- [Claude Remote Access](/docs/claude-remote)
- [Local AI Switch](/docs/local-ai-switch)
