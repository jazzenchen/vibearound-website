...
Use this page when the goal is to control or inspect a local Codex CLI workflow from another device. If you are comparing hosted Codex workflows, official mobile access, SSH, tunnels, and VibeAround's approach, where execution stays on your own computer, read [Codex Remote Comparison](./codex-remote) after this setup path.
