...
Use this page when the goal is to control or inspect a local Codex CLI workflow from another device. If you are comparing hosted Codex workflows, official mobile access, SSH, tunnels, and VibeAround's local-first model, read [Codex Remote Comparison](./codex-remote) after this setup path.
