...
The command-line distribution is published separately as [VibeAround CLI 0.0.5](https://github.com/jazzenchen/VibeAround/releases/tag/va-v0.0.5). Use the desktop links above for the packaged app, and install the current CLI from npm with:
