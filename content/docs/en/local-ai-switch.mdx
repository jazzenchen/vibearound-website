---
title: Local AI Switch
description: Switch agents, provider profiles, model aliases, workspaces, and bridge routes without turning the local workflow into a hosted workspace.
---
