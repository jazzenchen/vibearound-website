...
1. Install VibeAround from [Download](/docs/download).
2. Verify one agent works locally with [Quick Start](/docs/quick-start).
3. Add the project as a workspace.
4. Start a session through [Agent Launch](/docs/agent-launch).
5. Enable one remote surface: [Session Handover](/docs/session-handover), [Remote Messaging & Web Terminal](/docs/remote-messaging-terminal), or [Live Preview](/docs/live-preview).
6. Review [Security Model](/docs/local-security) before enabling tunnels or public-facing links.
...
- [Session Handover](/docs/session-handover)
