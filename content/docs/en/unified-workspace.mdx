...
*Details: [workspace module internals](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/modules/workspace.md) · [`va workspace` commands](./command-line) · [`default_workspace` / `workspaces` settings](https://github.com/jazzenchen/VibeAround/blob/main/docs/reference/configuration.md#settingsjson)*
...
*Details: [session lifecycle](./session-handover) (what survives what) · [handover flow](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/flows/handover.md) · [`va launch sessions` commands](./command-line)*
