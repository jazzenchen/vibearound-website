...
*Details: [workspace module internals](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/modules/workspace.md) · [`va workspace` commands](https://github.com/jazzenchen/VibeAround/blob/main/docs/reference/cli.md#workspaces-previews-profiles) · [`default_workspace` / `workspaces` settings](https://github.com/jazzenchen/VibeAround/blob/main/docs/reference/configuration.md#settingsjson)*
...
*Details: [session lifecycle](./session-handover) (open/close rules, restart behavior) · [workspace module internals](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/modules/workspace.md) · [subagent MCP tools](https://github.com/jazzenchen/VibeAround/blob/main/docs/reference/api-surfaces.md#mcp-tools)*
...
*Details: [supported agents matrix](./supported-agents) · [agent module internals](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/modules/agent.md) · [launch subsystem](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/launch.md) (how agents are started) · [`/switch` command reference](./remote-messaging-terminal)*
...
*Details: [model profiles guide](./provider-profiles) (setup) · [provider endpoints reference](./providers) (plans, base URLs, models) · [bridge mechanism](https://github.com/jazzenchen/VibeAround/blob/main/docs/architecture/local-api-and-bridge.md) · [profiles module internals](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/modules/profiles.md)*
...
*Details: [session lifecycle](./session-handover) (what survives what) · [handover flow](https://github.com/jazzenchen/VibeAround/blob/main/docs/internals/flows/handover.md) · [`va launch sessions` commands](https://github.com/jazzenchen/VibeAround/blob/main/docs/reference/cli.md#agents-and-launches)*
